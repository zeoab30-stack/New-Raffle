...
1. ⚙️ **የእቁብ ማስተካከያ** ውስጥ የመዋጮ መጠን፣ ድግግሞሽ፣ **የመጀመሪያ ቀን**፣ **የመሰብሰቢያ ቀን**፣ **የክፍያ ማብቂያ ቀን** (ለዚህ ዙር)፣ **የችሮታ ቀናት**፣ **ቅጣት %/ቀን**፣ **የቅጣት ጣሪያ %**፣ **የኮሚሽን %**፣ እና **ተከታታይ ያልከፈለ ቁጥር ለማገድ ጥቆማ** ያዘጋጁ
2. 👥 **አባላት** ውስጥ እያንዳንዱን አባል ስም/ስልክ ያስገቡ
3. ገንዘብ ሲሰበስቡ እያንዳንዱ አባል ላይ **"ከፍሏል"** ቁልፍ ይጫኑ፤ ያልከፈለ ካለ **"🔄 ቅጣት አስላ"** ተጭነው ቅጣት ራስ-ሰር ያሰላል (ከችሮታ ቀናት በኋላ በቀን በ% እየጨመረ፣ ከጣሪያው በላይ አያልፍም)
4. 🎲 **ዕጣ አውጣ** ይጫኑ — ገና ካላሸነፉ እና ካልታገዱ አባላት አንዱን በዘፈቀደ ይመርጣል፤ ከጠቅላላ ገንዘቡ ላይ የኮሚሽን % ተቀንሶ ቀሪው ለአሸናፊው ይሰላል፤ **💬 SMS በማስታወቂያ ላክ** ተጭነው በስልክዎ SMS መተግበሪያ ለአሸናፊው ያሳውቁ
5. ለቀጣይ ስብስብ **🔄 ለቀጣይ ስብስብ አጽዳ** ተጭነው ሁሉንም "አልከፈለም" ይመልሱ (ያልከፈለ ተከታታይ ቆጠራ ይጨምራል)
6. ተከታታይ ያልከፈለ ቁጥር ከደረሰ ስርዓቱ "⚠️ ማገድ ይመከራል" ብሎ ብቻ ይጠቁማል — **የመጨረሻውን ውሳኔ (ማገድ/መፍቀድ) ሁልጊዜ አስተዳዳሪው በእጅ ይወስናል** (🚫 አግድ / ✅ ፍቀድ ቁልፍ)
7. ሁሉም ብቁ አባላት ካሸነፉ በኋላ **🔁 አዲስ ዙር ጀምር** ተጭነው እንደገና ይጀምራሉ
8. 📜 **ታሪክ** ውስጥ ያለፉ ዙሮች፣ አሸናፊዎች እና ኮሚሽን ይመዘገባሉ

**የቅጣት/ማገድ ፖሊሲ (የተለመደ ዓለም አቀፍ ROSCA/ማይክሮፋይናንስ አካሄድ) / Penalty & Suspension Policy (common international ROSCA/microfinance practice):**
ችሮታ ቀናት → ከዚያ በኋላ ተመጣጣኝ %-ተኮር ቅጣት በቀን እየጨመረ (ጣሪያ ያለው) → ተደጋጋሚ ችግር ካለ የማገድ ጥቆማ → የመጨረሻ ውሳኔ ሁልጊዜ በሰው (አስተዳዳሪ)። ይህ ራስ-ሰር ማንንም አያግድም/አያባርርም፤ ግልጽነት እና ፍትሃዊነት ለመጠበቅ አስተዳዳሪው ሁሉንም መረጃ አይቶ ይወስናል።

⚠️ ይህ የገንዘብ ስብስብ ስርዓት ራሱ ገንዘብ አይይዝም/አያስተላልፍም — አባላት ውጭ ጥሬ ገንዘብ ወይም telebirr ይዋጣሉ፣ መተግበሪያው የዕጣ ማውጫና መዝገብ ብቻ ነው። ቅጣት/ኮሚሽን ስሌቶች ለክትትል እንጂ ራስ-ሰር ክፍያ አያደርጉም።

---

## 💬 SMS ማስታወቂያ / SMS Notifications

ምዝገባ ሲረጋገጥ እና ዕጣ/እቁብ አሸናፊ ሲወጣ **"💬 SMS ላክ"** ቁልፍ ይታያል። ይህ ቁልፍ የስልክዎን የSMS መተግበሪያ በራስ-ሰር ይከፍታል፣ ቁጥሩ እና መልእክቱ አስቀድሞ ተሞልቶ፣ እርስዎ ብቻ "Send" ይጫናሉ።

When a registration or draw completes, a "Send SMS" button appears. It opens your phone's own SMS app with the number and message pre-filled — you just tap send.

⚠️ ይህ ራስ-ሰር (automatic) SMS መላኪያ አይደለም፤ ራስ-ሰር ለመላክ የSMS gateway አካውንት (ለምሳሌ Africa's Talking) እና የኋላ-አገልግሎት (backend) ያስፈልጋል፣ ይህም ተጨማሪ ወጪ እና ማዋቀር ይጠይቃል። አሁን ያለው መንገድ ያለ ተጨማሪ ወጪ/አካውንት ወዲያውኑ ይሰራል።<br>
This is not fully automatic SMS — true auto-send requires an SMS gateway account (e.g., Africa's Talking) and a backend service, which costs money and needs setup. The current tap-to-send approach works immediately at no extra cost.
